...
public class SkillTreeButtons : MonoBehaviour
{
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().maxHPMinusSpeedUpgrade < 5)
        {
    ...
    public void Defense()
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().defense < 25)
        {
            saveManager.GetComponent<SaveManager>().defense = saveManager.GetComponent<SaveManager>().defense + 5;
            saveManager.GetComponent<SaveManager>().speed = saveManager.GetComponent<SaveManager>().speed - .5f;
            saveManager.GetComponent<SaveManager>().expNeeded = Mathf.RoundToInt(saveManager.GetComponent<SaveManager>().expNeeded * 1.1f);
            saveManager.GetComponent<SaveManager>().exp = saveManager.GetComponent<SaveManager>().exp - saveManager.GetComponent<SaveManager>().expNeeded;
        }
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().healthRegenMinusHPUpgrade < 5)
        {
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().healthRegenMinusSpeedUpgrade < 5)
        {
            saveManager.GetComponent<SaveManager>().healthRegen = saveManager.GetComponent<SaveManager>().healthRegen + 30;
            saveManager.GetComponent<SaveManager>().speed = saveManager.GetComponent<SaveManager>().speed - .5f;
            saveManager.GetComponent<SaveManager>().expNeeded = Mathf.RoundToInt(saveManager.GetComponent<SaveManager>().expNeeded * 1.1f);
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().critChance < 60)
        {
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().healthRegenMinusHPUpgrade < 7)
        {
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().fullHealthSwing == false && saveManager.GetComponent<SaveManager>().notFullHealthSwing == false)
        {
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().startleDamage < 5)
        {
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().startleCritDamage < 5)
        {
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().speed < 5.5f)
        {
            saveManager.GetComponent<SaveManager>().speed = saveManager.GetComponent<SaveManager>().speed + .5f;
            saveManager.GetComponent<SaveManager>().expNeeded = Mathf.RoundToInt(saveManager.GetComponent<SaveManager>().expNeeded * 1.1f);
            saveManager.GetComponent<SaveManager>().exp = saveManager.GetComponent<SaveManager>().exp - saveManager.GetComponent<SaveManager>().expNeeded;
    ...
    {
        if (saveManager.GetComponent<SaveManager>().exp > saveManager.GetComponent<SaveManager>().expNeeded && saveManager.GetComponent<SaveManager>().speedByHealth == false && saveManager.GetComponent<SaveManager>().speedByMissingHealth == false)
        {
